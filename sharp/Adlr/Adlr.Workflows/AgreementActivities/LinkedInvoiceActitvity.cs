...
{
    public class LinkedInvoiceActitvity : CodeActivity
    {

        
        [Output("Is invoice linked")]
        ...
        protected override void Execute(CodeActivityContext context)
        {
            ...
            try
            {
                ...
                var invoices = activitiesService.GetInvoicesByLinkedAgreement(wfContext.PrimaryEntityId);
